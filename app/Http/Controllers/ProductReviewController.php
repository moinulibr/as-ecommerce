...
class ProductReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $view = view("products.reviewList", compact("product"))->render();
        $url=route('front.products.show', [$product->slug]);
        return response()->json(['status'=>true,'msg'=>'Product Review Is Created successfully!', 'view'=>$view,'url'=>$url]);
    }
