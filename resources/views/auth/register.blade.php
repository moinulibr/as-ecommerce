...
<head>
    ...
    <title>Amader Sanitary - Create Account</title>
    ...
    <div class="flex-grow flex flex-col justify-center items-center px-4 space-y-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
            ...
            <form method="POST" action="{{ route('register') }}">
                @csrf
                <div class="mb-4">
                    <label class="block text-gray-700 mb-2" for="name">Name <span
                            class="text-red-500">*</span></label>
                    <input type="name" id="name" value="{{ old('name') }}" required name="name"
                        class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter your name"/>
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 mb-2" for="mobile">Mobile Number <span
                            class="text-red-500">*</span></label>
                    <input type="tel" id="mobile" value="{{ old('mobile') }}" required name="mobile"
                ...
                <div class="mb-6">
                    <label class="block text-gray-700 mb-2" for="password">Confirm Password <span
                            class="text-red-500">*</span></label>
                ...
                <button type="submit" class="w-full bg-gray-900 text-white p-3 rounded-lg hover:bg-gray-800 mb-4">
                    Create Your Account
                </button>
                ...
                <p class="text-center mt-4">
                    have and account? <a href="{{ route('login') }}" class="text-blue-500 hover:underline">Sign in</a>
                </p>
            </form>
        </div>
    </div>
