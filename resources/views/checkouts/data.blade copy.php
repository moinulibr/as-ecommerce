...
<div class="bg-gray-50 p-6 rounded-lg border border-gray-100">
    ...
    <!-- Table Header -->
    <!--<div class="grid grid-cols-12 text-sm font-bold text-gray-900 pb-2 border-b border-gray-200">-->
    ...
    <!-- Product Item Row -->
    <!--<div class="grid grid-cols-12 items-center py-4 border-b border-gray-200 text-sm">-->
    <!--    <div class="col-span-6 pr-2">-->
    <!--        <div class="font-medium text-gray-900 text-[15px]">ছারপোকা নির্মূল ফর্মুলা</div>-->
    <!--        <div class="text-xs text-gray-400 mt-1">Size: 3-পিছ ছারপোকার বোতল</div>-->
    <!--    </div>-->
    <!--    <div class="col-span-3 flex justify-center">-->
    <!--        <div class="flex items-center border border-gray-200 rounded bg-white text-xs">-->
    <!--            <button class="px-2 py-1 text-gray-500 hover:bg-gray-100">-</button>-->
    <!--            <span class="px-2 py-1 text-gray-900 font-medium">1</span>-->
    <!--            <button class="px-2 py-1 text-gray-500 hover:bg-gray-100">+</button>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--    <div class="col-span-3 text-right font-medium text-gray-900">-->
    <!--        1390৳-->
    <!--    </div>-->
    <!--</div>-->
    ...
    <!-- Coupon Section -->
    {{---
    <div class="py-4 border-b border-gray-200 flex items-center justify-between gap-4">
        <span class="font-bold text-gray-900 text-sm whitespace-nowrap">Coupon</span>
        <input type="text" placeholder="Enter coupon code" id="coupon_code" class="w-full max-w-[200px] bg-white border border-gray-200 rounded-md py-2 px-3 text-sm focus:outline-none focus:border-gray-400">
    ...
    <div class="flex justify-between">
        ...
        <p class="text-gray-800 font-medium">
            <span id="checkoutTotalAmount" class="sub_total" data-totalamount="{{getTotalAmount() -$cdiscount}}" data-totalvendor="{{totalVendorCart()}}">{{priceFormate(getTotalAmount())}}</span>
        </p>
    </div>
    ...
    <button type="submit" class="w-full bg-blue-400 hover:bg-blue-500 text-white font-bold py-3 rounded-md shadow-sm transition flex items-center justify-center gap-2 text-base md:text-lg">
        <!-- Simple SVG Cart Icon matches image pattern -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
        </svg>
        Place Order — TK <span class="total_amount">{{priceFormate(getTotalAmount() - $cdiscount)}} </span>
    </button>
    --}}
    ...
    <!-- Submit/Place Order Button -->
    {{--<button type="submit" class="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-md shadow transition flex items-center justify-center gap-2 text-base md:text-lg">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
        </svg>
        <span>Place Order — <span class="total_amount">{{priceFormate(getTotalAmount() - $cdiscount)}}</span></span>
    </button>--}}

    <!-- Submit/Place Order Button with Dynamic Spinner Loader -->
    <button type="submit" id="btn_submit_order" class="w-full mt-6 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-bold py-3 px-4 rounded-md shadow transition flex items-center justify-center gap-2 text-base md:text-lg">
        ...
        <!-- Animated Loading Spinner (Hidden by default) -->
